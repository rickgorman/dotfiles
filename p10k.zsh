# Generated by Powerlevel10k configuration wizard on 2023-02-19 at 01:03 MST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 6447.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# slanted separators, sharp heads, slanted tails, 2 lines, dotted, no frame,
# dark-ornaments, sparse, few icons, fluent, instant_prompt=quiet.
